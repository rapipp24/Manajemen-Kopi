                ...
                <tr>
                    <td colspan="7">
                        <div class="empty-state">
                            ...
                            <div class="empty-title">Belum ada setoran</div>
                            <div class="empty-desc">Setoran uang yang kamu kirim ke admin akan tampil di sini.</div>
                            <a href="{{ route('sales.deposits.create') }}" class="empty-btn">
                                <i data-lucide="plus"></i> Kirim Setoran Pertama
                            </a>
                        </div>
                    </td>
                </tr>
