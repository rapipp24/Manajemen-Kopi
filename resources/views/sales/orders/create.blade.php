<x-layouts.user>
    ...
    <style>
        ...
        .page-desc  { font-size:13px;color:#78716c;margin-bottom:22px; }

        /* ── Layout ──────────────────────────── */
        .layout { display:grid;grid-template-columns:296px 1fr;gap:16px;align-items:start; }
        ...
        .card-header p  { font-size:11.5px;color:#78716c;margin:2px 0 0; }
        ...
        /* ── Add-item button ─────────────────── */
        .btn-add {
            width:100%;padding:9px;background:#1c1917;color:#fff;
            border:none;border-radius:8px;font-size:13px;font-weight:700;
            cursor:pointer;margin-top:6px;transition:background 0.12s;font-family:inherit;
        }
        .btn-add:hover { background:#2d2825; }

        /* ── Item list ───────────────────────── */
        .item-empty { padding:44px 20px;text-align:center; }
        .item-empty-emoji { font-size:28px;opacity:0.2;margin-bottom:8px; }
        .item-empty p { font-size:12.5px;color:#a8a29e;line-height:1.5; }
        ...
        .item-name { flex:1;font-size:13px;font-weight:600;color:#1c1917;line-height:1.3; }
        .item-qty  { font-size:12.5px;font-weight:700;color:#57534e;min-width:26px;text-align:center; }
        .item-est  { font-size:12px;color:#78716c;min-width:80px;text-align:right; }
        .item-del  { background:none;border:none;color:#d6d3d1;cursor:pointer;font-size:18px;line-height:1;padding:2px 4px;transition:color 0.12s; }
        .item-del:hover { color:#ef4444; }

        /* ── Total & Submit ──────────────────── */
        .total-row {
            display:flex;justify-content:space-between;align-items:center;
            padding:13px 18px;border-top:1px solid #ece8e3;background:#fafaf8;
        }
        .total-label { font-size:11px;font-weight:700;color:#a8a29e;text-transform:uppercase;letter-spacing:0.06em; }
        .total-value { font-size:19px;font-weight:800;color:#92400e;letter-spacing:-0.02em; }

        .btn-submit {
            width:100%;padding:11px;background:#92400e;color:#fff;border:none;
            border-radius:9px;font-size:13.5px;font-weight:700;cursor:pointer;
            transition:background 0.12s,box-shadow 0.12s;font-family:inherit;
            box-shadow:0 1px 3px rgba(146,64,14,0.25);
        }
        .btn-submit:hover { background:#78350f;box-shadow:0 3px 8px rgba(146,64,14,0.3); }

        .badge-count {
            background:#92400e;color:#fff;
            padding:2px 7px;border-radius:10px;font-size:10px;font-weight:700;margin-left:5px;
        }
