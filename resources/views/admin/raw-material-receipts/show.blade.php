<x-layouts.admin>
    ...
    <style>
        ...
        @media print {
            ...
            .card-header { background: white !important; padding: 0 0 20px 0 !important; border-bottom: 2px solid #000 !important; }
            .card-body { padding: 20px 0 !important; }
            ...
            .signature-line { margin-top: 60px; border-top: 1px solid #000; padding-top: 5px; font-weight: 700; }
            
            /* A5 Adjustments */
            .is-a5 { width: 148mm; min-height: 210mm; padding: 10mm; margin: auto; }
            .is-a5 .info-value { font-size: 13px; }
            .is-a5 .item-table td, .is-a5 .item-table th { padding: 8px 10px; font-size: 12px; }
            .is-a5 .grand-total-box { padding: 12px; margin-top: 15px; }
                    ...
                    @foreach($receipt->items as $item)
                        <tr>
                            ...
                            <td style="text-align: right;">
                                ...
                                <span style="font-size: 11px; color: var(--text-muted); font-weight: 700;">{{ $item->rawMaterial->unit->code }}</span>
                            </td>
