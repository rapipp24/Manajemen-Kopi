    ...
    <div style="max-width: 600px; background: white; border-radius: 12px; border: 1px solid #e2e8f0; padding: 32px;">
        <form action="{{ route('admin.suppliers.update', $supplier->id) }}" method="POST">
            ...
            <div style="margin-bottom: 20px;">
                ...
                <input type="text" name="name" value="{{ old('name', $supplier->name) }}" required placeholder="Contoh: PT. Biji Kopi Makmur"
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-bottom: 20px;">
                <div>
                    ...
                    <input type="text" name="contact_person" value="{{ old('contact_person', $supplier->contact_person) }}" placeholder="Nama orang yg bisa dihubungi"
                ...
                <div>
                    ...
                    <input type="text" name="phone" value="{{ old('phone', $supplier->phone) }}" placeholder="Contoh: 08123456xxx"
            ...
            <div style="margin-bottom: 28px;">
                ...
                <textarea name="address" rows="3" placeholder="Alamat kantor atau gudang supplier"
                          style="width: 100%; padding: 12px; border: 1px solid {{ $errors->has('address') ? '#ef4444' : '#cbd5e1' }}; border-radius: 8px; font-size: 14px; font-family: inherit;">{{ old('address', $supplier->address) }}</textarea>
