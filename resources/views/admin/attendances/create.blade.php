<x-layouts.admin>
    ...
    <div class="page-header">
        <h1>Catat Absensi Karyawan Gudang</h1>
        <p>Catat kehadiran manual karyawan gudang.</p>
    </div>
    ...
    <div class="form-card">
        <form action="{{ route('admin.attendances.store') }}" method="POST">
            ...
            <div class="form-group">
                <label class="form-label" for="warehouse_employee_id">Pilih Karyawan <span style="color:#dc2626;">*</span></label>
            ...
            <div class="form-group">
                ...
                <textarea name="note" id="note" rows="3"
                          ...
                          placeholder="Masukkan alasan jika izin, atau catatan jika ada.">{{ old('note') }}</textarea>
                @error('note')
                    <span class="invalid-feedback">{{ $message }}</span>
                @enderror
            </div>

            <button type="submit" class="btn-submit" id="btn-simpan-absensi">Simpan Absensi</button>
        </form>
    </div>
