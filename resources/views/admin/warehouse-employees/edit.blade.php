<x-layouts.admin>
    <x-slot name="title">Edit Karyawan Gudang</x-slot>
    ...
    <div style="margin-bottom: 24px;">
        <h1 style="font-size: 20px; font-weight: 700; color: var(--text-main); margin: 0;">Edit Karyawan Gudang</h1>
        <p style="font-size: 13px; color: var(--text-muted); margin: 4px 0 0 0;">Perbarui informasi detail karyawan gudang.</p>
    </div>
    ...
    <div style="background: white; border-radius: 16px; border: 1px solid var(--border); padding: 28px; max-width: 520px; box-shadow: 0 2px 8px rgba(120, 53, 15, 0.02);">
        <form action="{{ route('admin.warehouse-employees.update', $warehouseEmployee->id) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div style="margin-bottom: 20px;">
                ...
                <input type="text" name="name" id="name" required
                       ...
                       value="{{ old('name', $warehouseEmployee->name) }}"
            ...
            <div style="margin-bottom: 20px;">
                ...
                <input type="text" name="phone" id="phone"
                       ...
                       value="{{ old('phone', $warehouseEmployee->phone) }}"
            ...
            <div style="margin-bottom: 20px;">
                ...
                <textarea name="note" id="note" rows="3"
                          ...
                          onfocus="this.style.borderColor='var(--brown-500)'" onblur="this.style.borderColor='var(--border)'">{{ old('note', $warehouseEmployee->note) }}</textarea>
                @error('note')
                    <span style="color: #dc2626; font-size: 12px; margin-top: 4px; display: block;">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div style="margin-bottom: 24px;">
                ...
                <label style="display: flex; align-items: center; gap: 12px; cursor: pointer;">
                    ...
                    <input type="checkbox" name="is_active" id="is_active" value="1"
                           {{ old('is_active', $warehouseEmployee->is_active) ? 'checked' : '' }}
