<x-layouts.admin>
    ...
    <div class="page-header">
        <h1>Edit Karyawan Gudang</h1>
        <p>Perbarui informasi detail karyawan gudang.</p>
    </div>
        ...
        <form action="{{ route('admin.warehouse-employees.update', $warehouseEmployee->id) }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="name" id="name"
                       ...
                       value="{{ old('name', $warehouseEmployee->name) }}" required>
                @error('name')
            ...
            <div class="form-group">
                ...
                <textarea name="note" id="note" rows="3"
                          ...
                          placeholder="Catatan tambahan jika diperlukan.">{{ old('note', $warehouseEmployee->note) }}</textarea>
                @error('note')
                    <span class="invalid-feedback">{{ $message }}</span>
                @enderror
            </div>
            ...
            <button type="submit" class="btn-submit" id="btn-update-karyawan">Perbarui Karyawan</button>
        </form>
    </div>
</x-layouts.admin>
